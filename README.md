# nvim-treesitter-queries-godot_resource

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-godot_resource/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-godot_resource/actions/workflows/validate.yml)

Neovim tree-sitter queries for **godot_resource**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-godot_resource",
...
- [ ] Changes are scoped to `godot_resource` — do not include files for other languages
